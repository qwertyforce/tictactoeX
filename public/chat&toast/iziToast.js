		...
		(function(){
			if(settings.close){
				...
				if(settings.rtl){
					...
					var LeftPadding=document.getElementById("LeftColumn").clientWidth;
	var RightPadding=document.getElementById("RightColumn").clientWidth;
						$DOM.toastCapsule.style.paddingRight = RightPadding;
					$DOM.toastCapsule.style.paddingLeft = LeftPadding;
				}
			}
		})();
